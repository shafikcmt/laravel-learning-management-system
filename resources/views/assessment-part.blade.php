    ...
    <section class="section">
         <div class="row sameheight-container ">
            <div class="col-md-12">
                ...
                <div class="title-block">
                        <h1  class="title well p-2 bg-orange text-white"> Drive Skills<a href="#"><button class="btnhead">Detail Report</button> </a> <a href="/assessment-work"><button class="btnhead">Back</button> </a> </h1>
                    </div>
